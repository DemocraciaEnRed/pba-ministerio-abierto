...
usePrivatePageSeo('Consultas - Observatorio')
...
<template>
  <UPage>
    <UPageHeader
      title="Consultas del Observatorio"
      description="Son aquellas consultas creadas cuyo tipo es Observatorio de Obras y Servicios Públicos."
    >
      <template #links>
        <UButton
          label="Actualizar"
